...
_this addWeapon 'rhs_weap_m24sws_wd';
_this addPrimaryWeaponItem 'hlc_optic_LeupoldM3A';
...
_this addVest _Vest; 
for '_i' from 1 to 6 do { _this addItemToVest 'rhsusf_5Rnd_762x51_m993_Mag';};
for '_i' from 1 to 2 do { _this addItemToVest 'rhsusf_5Rnd_762x51_m62_Mag';};
