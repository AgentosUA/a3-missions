...
_this addBackpack 'usm_pack_alice_prc77';
...
for '_i' from 1 to 10 do { _this addItemToBackpack  'ACE_splint';};
...
for '_i' from 1 to 5 do { _this addItemToBackpack  'ACE_bloodIV_500';};
